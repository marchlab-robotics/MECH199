...
Summary: Plot sEMG sensor raw and processed signal(amplifierd-ractified) using serial plotter
...
#define PIN_RAW      A1        // sEMG sensor raw signal pin
//========== PIN MAP ==========
...
void loop() {
  ...
  int sEMG_SIG = analogRead(PIN_RAW);   // read sEMG raw value from sEMG sensor
  ...
  Serial.print(",");        // print separator of valuse
  Serial.print((sEMG_RAW-490)*10); // print the sensor raw input value
  Serial.print(",");        // print separator of valuse
